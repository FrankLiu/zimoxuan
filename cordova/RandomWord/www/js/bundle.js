...
var Vue = require('E:\\workspace\\zimoxuan\\cordova\\RandomWord\\node_modules\\vue\\dist\\vue');
...
},{"./random-word.vue":7,"E:\\workspace\\zimoxuan\\cordova\\RandomWord\\node_modules\\vue\\dist\\vue":4,"vue-resource":3}],7:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
	data: function data() {
		return {
			randomWord: '',
			words: ['formidable', 'gracious', 'daft', 'mundane', 'onomatopoeia']
		};
	},
	...
	methods: {
		getRandomWord: function getRandomWord() {
			...
			this.$http.get('http://api.wordnik.com:80/v4/words.json/randomWord?hasDictionaryDef=false&minCorpusCount=0&maxCorpusCount=-1&minDictionaryCount=1&maxDictionaryCount=-1&minLength=5&maxLength=-1&api_key=a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5').then(function (response) {
...
__vue__options__.render = function render () {var _vm=this;return _vm._h('div',{staticClass:"app",attrs:{"id":"vue-instance"}},[_vm._h('h1',["Random Word"])," ",_vm._h('button',{attrs:{"id":"btn-get-random-word"},on:{"click":_vm.getRandomWord}},["Get Random Word"])," ",_vm._h('p',[_vm._s(_vm.randomWord)])])}
